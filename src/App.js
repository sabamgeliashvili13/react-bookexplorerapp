              ...
              <>
                {!viewFavourites && (
                  <>
                    ...
                    />
                    <div>
                      <Button1 onClick={prevPage} disabled={currentPage === 1}>
                        Previous
                      </Button1>
                      <Button1
                        onClick={nextPage}
            ...
            element={
              <div className="contact-page">
                <div className="contact-box">
                  <span>
                    {" "}
                    <i class="fa-solid fa-phone font-awesome-icon"></i> +995 551
                    73 33 42
                  </span>
                  <span>
                    {" "}
                    <i class="fa-solid fa-envelope font-awesome-icon"></i>{" "}
                    Bookexplorer@gmail.com
                  </span>
                  <span>
                    {" "}
                    <i class="fa-solid fa-location-dot font-awesome-icon"></i>{" "}
                    Tbilisi,Abashidze street 34
                  </span>
                </div>
